...
Viewed from slightly above at a gentle tilt — not straight-on, not flat. The book is angled so you can see the front cover, a portion of the spine, and a sliver of the top edge. This is how Cultist Simulator renders its untranslated book sprites.

A plain notebook with a rounded spine. Rectangular block, flat brown fill within a clean outline. No title. No cover decoration. The slight angle makes the book feel like an object sitting on a surface — but do not draw the surface. Remove unnecessary detail.

A paper band wraps horizontally around the book — it follows the angle, wrapping across the cover and spine. On the band, a single Cyrillic letter in dark brown.
```
