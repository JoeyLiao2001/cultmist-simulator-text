...
参考游戏刃之追随者 sprite 的面部画法：干净均匀的黑色轮廓线，大面积平涂色块，无渐变，无排线，无纹理，光滑表面。方形画布，无边无饰。
...
```
Cultist Simulator location sprite. Clean uniform-weight outlines enclosing flat color areas. No gradients. No hatching. No texture. Smooth surface. Square canvas with flat ground, no border.

Background: a flat wash of deep jungle green — dark, still, the color of rainforest canopy at noon with no sky visible.

Colors: use only the jungle palette — deep green background, rust-brown rail, dark brown outlines.

A section of narrow-gauge railway track, seen close. The iron rail bends sharply upward from the middle of the gravel roadbed — twisted into a reverse arc, pulled from below, not collapsed from above. Wrench-teeth marks visible at the bend, rendered as a few clean horizontal notches. The rail is deeply rusted — darker than dried blood. A thin pool of rainwater sits in the sunken roadbed beneath the bend — a single dark flat shape. At the frame edges, banyan aerial roots descend — a few clean lines, flat dark brown fills.

No figures. No sky. No leaves on the rail. The rust is the warmest thing in the frame.
```
