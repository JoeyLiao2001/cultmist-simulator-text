...
1. **长度控制**：核心描述引文 15-80 字（中位 28 字，平均 34 字）。极简优先。CS 最经典的描述往往不超过 30 字。
2. **文言虚词密度**：真实 CS 文本中"之""者""其""此""于""为""所""斯"出现频率显著高于现代中文。每句 1-2 个即可，不堆砌。
3. **神秘主义句式**：数据集高频句式——"据说……""某一……""某种……""无人知晓……""……已……""……将……"
4. **克制描写**：不说"恐怖"，说"静默中的东西"；不说"永生"，说"他已很久没有变化了"。
5. **碎片化叙事**：描述像一块碎片——暗示更大、未言明的世界。不做解释。
6. **Lore 锚定**：每条描述至少与一个已知 CS 元素产生共鸣（司辰、准则、漫宿区域、已知典籍、历史事件、社团）。
