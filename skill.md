...
2. **文言虚词**：密度约 4.9%，每 20 字出现 1 个。频率排序：之 > 为 > 者 > 于 > 以 > 将。自然融入，不堆砌。
3. **句式与结尾**：87% 的描述以句号结尾——克制的事实陈述是主调。少用问号（1.1%）和感叹号（0.6%）。"据说"仅出现 16 次（0.8%），并非主要模式。
4. **叙事视角**：33% 第一人称（"我"），25% 第三人称（"他/她"）。无主导视角——选择适合实体的即可。
5. **克制描写**：不说"恐怖"，说"静默中的东西"；不说"永生"，说"他已很久没有变化了"。
6. **碎片化叙事**：描述像一块碎片——暗示更大、未言明的世界。不做解释。
7. **Lore 锚定**：每条描述至少与一个已知 CS 元素产生共鸣（司辰、准则、漫宿区域、已知典籍、历史事件、社团）。
8. **禁止**：现代口语、语气词（吧呢啊）、解释性语句（"这是因为……"）、情绪化感叹。
